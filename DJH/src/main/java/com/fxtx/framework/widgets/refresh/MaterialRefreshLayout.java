...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr) {
        ...
        isHeadView = t.getBoolean(R.styleable.MaterialRefreshLayout_head_show, true);
    ...
    protected void onAttachedToWindow() {
        ...
        setWaveHeight(BaseUtil.dip2px(context, waveHeight));
        setHeaderHeight(BaseUtil.dip2px(context, headHeight));
        if (isHeadView) {
        ...
        LayoutParams layoutParams2 = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, BaseUtil.dip2px(context, hIGHER_HEAD_HEIGHT));
    ...
    /**
     * @return Whether it is possible for the child view of this store_null to
