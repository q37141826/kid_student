...
public class OkHttpPostRequest extends OkHttpRequest {
    ...
    protected OkHttpPostRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, MediaType mediaType, String content, byte[] bytes, File file,String json) {
