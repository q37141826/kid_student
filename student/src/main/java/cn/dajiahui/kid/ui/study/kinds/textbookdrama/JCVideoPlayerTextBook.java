...
*
* */
public class JCVideoPlayerTextBook extends JCVideoPlayerStandard {
    private OnDuration onDuration;

    public JCVideoPlayerTextBook(Context context) {
        super(context);
    }

    public JCVideoPlayerTextBook(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
