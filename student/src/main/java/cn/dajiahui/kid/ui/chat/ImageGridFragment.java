...
import cn.dajiahui.kid.ui.chat.util.ImageCache;
import cn.dajiahui.kid.ui.chat.util.ImageResizer;
import cn.dajiahui.kid.ui.chat.util.Utils;

public class ImageGridFragment extends EaseBaseFragment implements OnItemClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        final GridView mGridView = getView( R.id.gridView);
    ...
    protected View initinitLayout(LayoutInflater inflater) {
        return inflater.inflate(R.layout.em_image_grid_fragment, null);
    }
