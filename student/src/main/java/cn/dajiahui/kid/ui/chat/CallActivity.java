...
//                        }
    ...
    protected void saveCallRecord() {
        ...
        if (callType == 0)
            message.setAttribute(com.hyphenate.easeui.EaseConstant.MESSAGE_ATTR_IS_VOICE_CALL, true);
        else
            message.setAttribute(com.hyphenate.easeui.EaseConstant.MESSAGE_ATTR_IS_VIDEO_CALL, true);
