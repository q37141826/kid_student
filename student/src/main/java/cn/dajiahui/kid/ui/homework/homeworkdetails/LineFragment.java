...
public class LineFragment extends BaseHomeworkFragment implements CheckHomework, Sublineinfo, View.OnClickListener {
    ...
    /*我的答案的集合*/
    private List<Map<String, String>> MyanswerList = new ArrayList<>();
...
//        inbasebean = h2.parsingObject(LineQuestionModle.class);
    ...
    /*删除线*/
    private void removeLine(LineImagePointView firstView, LineImagePointView secondView) {
        /* 查找firstView */
    ...
    /*添加线*/
    private void addLine(LineImagePointView firstView, LineImagePointView secondView) {
        DrawPath path = null;
        if (firstView.getDirection() == Dir.left) {
        ...
        if (inbasebean.isAnswer() == true) {
            ...
            /*判断再次点击的是不是自己  是自己 就把 点击的view付给选择的currentSelectedView*/
                ...
                /* 判断是否同侧点 */
                    ...
                    /* 非同侧view */
                    /*先删除*/
                        removeLine(currentSelectedView, lineImagePointView);
                    /*必须每次都要new出来 要不不显示划线*/
                        ...
                        addLine(currentSelectedView, lineImagePointView);
        ...
        switch (v.getId()) {
            case R.id.mLeft:
                ...
                if (inbasebean.isAnswer() == true) {
                    ...
                    Logger.d("majin", "我的答案:" + mMineRPonitList.toString());
...
//                    Toast.makeText(activity, "我的答案", Toast.LENGTH_SHORT).show();
            ...
            case R.id.mRight:
                ...
                if (inbasebean.isAnswer() == true) {
                    draw_root.removeAllViews();
//                    Logger.d("majin", "正确答案:" + mMineRPonitList.toString());
