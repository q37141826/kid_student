...
public class RecorderVideoActivity extends EaseBaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onBackText();
        setfxTtitle(R.string.recording_video);
    }
    ...
    protected void initView() {
        ...
        mWakeLock = pm.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK,
                CLASS_LABEL);
        mWakeLock.acquire();
        btn_switch = getView(R.id.switch_btn);
        btn_switch.setOnClickListener(this);
        btn_switch.setVisibility(View.VISIBLE);
        mVideoView = getView(R.id.mVideoView);
        btnStart = getView(R.id.recorder_start);
        btnStop = getView(R.id.recorder_stop);
