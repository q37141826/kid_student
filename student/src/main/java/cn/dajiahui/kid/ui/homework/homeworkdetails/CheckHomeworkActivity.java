            ...
            if (PageMap.get(position) != null) {
               ...
               /*判断题*/
                ...
                /*填空题*/
                    ...
                    Logger.d("majin", "填空position" + position);
                    CompletionQuestionModle complete = (CompletionQuestionModle) PageMap.get(position);
                    if (complete.getmAllMap() != null) {
                        Logger.d("majin", "翻页回来integerMapMap:" + complete.getmAllMap().size());
                        Logger.d("majin", "翻页回来integerMapMap:" + complete.getmAllMap().toString());
...
//                        completionFragment.submitHomework(complete);
                        ...
                        Logger.d("majin", "翻页回来integerMapMap: " + complete.getmAllMap());
                    }
...
//            }
    ...
    private class Adapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (subjectype.equals(Constant.Judje)) {
                ...
                if (PageMap.get(position) != null) {
                    questionModle.setJudgeAnswerFlag(((JudjeQuestionModle) PageMap.get(position)).getJudgeAnswerFlag());//获取判断题选择答案的标记（mtrue 正确 mfalse 错误）
                ...
                if (PageMap.get(position) != null) {
                    ...
                    questionModle.setAnswer(((SortQuestionModle) PageMap.get(position)).isAnswer());//学生是否提交
                ...
                if (PageMap.get(position) != null) {
                    Logger.d("majin", " 填空当前页:" + currentposition);
                    Logger.d("majin", "((CompletionQuestionModle) PageMap.get(position)).getmAllMap():" + ((CompletionQuestionModle) PageMap.get(position)).getmAllMap());
                    questionModle.setmAllMap(((CompletionQuestionModle) PageMap.get(position)).getmAllMap());
                }
    ...
    public void submitJudgeFragment(JudjeQuestionModle questionModle) {
        ...
        qm.setCurrentpage(currentposition);//当前是第几页
...
//        qm.setmAllMap(questionModle.getmAllMap());
