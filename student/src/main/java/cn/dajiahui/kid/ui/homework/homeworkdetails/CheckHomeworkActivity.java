...
//                  questionModle.setAnswer(((JudjeQuestionModle) PageMap.get(position)).isAnswer());//学生是否提交
                ...
                choiceModle.setSubjectype(subjectype);//保存当前的题型
...
//                questionModle.setStandard_answer(((CompletionQuestionModle) mDatalist.get(position)).getStandard_answer());//保存当前题的正确答案
                if (PageMap.get(position) != null) {
                    questionModle.setAnswerflag(((CompletionQuestionModle) PageMap.get(position)).getAnswerflag());//学生作答标记
                    questionModle.setmAllMap(((CompletionQuestionModle) PageMap.get(position)).getmAllMap());//保存自己答案的集合
                }
    ...
    public void submitJudgeFragment(JudjeQuestionModle questionModle) {
        ...
        qm.setSubjectype(questionModle.getQuestion_cate_id());//获取试题类型
